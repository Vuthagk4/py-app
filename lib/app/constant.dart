...
// constant.dart - fix kBorderGradientColor
var kBorderGradientColor = LinearGradient(
  colors: [
    Colors.red.withOpacity(0.6),
    const Color(0xffFF72B6).withOpacity(0.44),
    const Color(0xffD9AFD9).withOpacity(0.61),
    const Color(0xff97E1D4).withOpacity(0.85),
  ],
...
var kHeadingTextStyle = const TextStyle(
  fontSize: 30.0,
